...
echo.
echo about to insert tube heat records ...
"C:\Program Files\MySQL\MySQL Server 5.5\bin\mysql"  -uroot -pfmi-drooga < ".\CTR2150.sql"
"C:\Program Files\MySQL\MySQL Server 5.5\bin\mysql"  -uroot -pfmi-drooga < ".\GS-5176.sql"
"C:\Program Files\MySQL\MySQL Server 5.5\bin\mysql"  -uroot -pfmi-drooga < ".\CTR2251.sql"
"C:\Program Files\MySQL\MySQL Server 5.5\bin\mysql"  -uroot -pfmi-drooga < ".\CTR2280.sql"
